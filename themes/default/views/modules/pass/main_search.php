...
<form name="fCustomPassSearch" autocomplete="off" action="<?=base_url($module.'/search')?>" method="GET" role="search">
    <div class="bgfade col-md-4 form-group go-right col-xs-6" id="name">
        <div class="row">
            ...
            <input type="text" placeholder="Search pass by name" name="name" class="form input-lg" required >
        </div>
    </div>
<!--    <div class="bgfade col-md-2 form-group go-right col-xs-6" id="pass_sales_date">-->
<!--        <div class="row">-->
<!--            <div class="clearfix"></div>-->
<!--            <i class="iconspane-lg icon_set_1_icon-53"></i>-->
<!--            <input type="text" placeholder="Select sales date" name="pass_sales_date" class="form input-lg dpd1" required >-->
<!--        </div>-->
<!--    </div>-->
    <div class="bgfade col-md-2 form-group go-right col-xs-6" id="ammount">
        <div class="row">
            <div class="clearfix"></div>
            <input type="number" placeholder="Amount" name="ammount" value="0" class="form input-lg" required >
        </div>
    </div>
