...
<form autocomplete="off" name="hotelportSearch" action="<?php echo base_url('hotelport'); ?>" method="GET" role="search">
    ...
    <div class="col-md-2 form-group go-right col-xs-12 search-button">
     <button type="submit"  class="btn-danger btn btn-lg btn-block pfb0"><i class="icon_set_1_icon-66"></i> <?php echo trans('012'); ?></button>
    </div>
</form>
