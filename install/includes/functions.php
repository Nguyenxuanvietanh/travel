...
', $php_version, '6.1', $required_php_version));
}
/* check if mysqli enabled */
if(!extension_loaded('mysqli')) {
_error("Installation Error", '
<p class="text-center">Your PHP installation appears to be missing the "mysqli" extension which is required by PHPTravels.</p>
<small>Back to your server admin or hosting provider to enable it for you</small>');
}
/* check if curl enabled */
if(!extension_loaded('curl')) {
_error("Installation Error", '
<p class="text-center">Your PHP installation appears to be missing the "cURL" extension which is required by PHPTravels.</p>
<small>Back to your server admin or hosting provider to enable it for you</small>');
}
/* check if json_decode enabled */
if(!function_exists('json_decode')) {
_error("Installation Error", '
<p class="text-center">Your PHP installation appears to be missing the "json_decode()" function which is required by PHPTravels.</p>
<small>Back to your server admin or hosting provider to enable it for you</small>');
}
...
<p class="text-center">"uploads" folder must be writable.');
    ...
    _error("Installation Error", '
<p class="text-center">Your PHP installation appears to be missing the "mb_internal_encoding()" function which is required by PHPTravels.</p>
<small>Back to your server admin or hosting provider to enable it for you</small>');
}
