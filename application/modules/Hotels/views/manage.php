      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input name="hotelname" type="text" placeholder="Hotel Name" class="form-control"
                value="<?php echo @$hdata[0]->hotel_title;?>" />
            </div>
          </div>
          <div class="row form-group">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <select data-placeholder="Select" class="form-control" name="hotelstars">
                ...
                <option value="<?php echo $stars;?>" <?php if(@$hdata[0]->hotel_stars == $stars){ echo 'selected'; } ?>>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <select data-placeholder="Select" class="form-control" name="hoteltype">
                ...
                <option value="<?php echo $ht->sett_id;?>"
                  <?php if(@$hdata[0]->hotel_type == $ht->sett_id){ echo 'selected'; } ?>><?php echo $ht->sett_name;?>
                </option>
                <?php } ?>
              </select>
            </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <input name="ffrom" type="text" placeholder="From" class="form-control dpd1"
                value="<?php echo @$featuredfrom; ?>" />
            </div>
            <div class="col-md-2">
              <input name="fto" type="text" placeholder="To" class="form-control dpd2"
                value="<?php echo @$featuredto; ?>" />
            </div>
            <?php  }else{ ?>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              ...
              <input type="hidden" name="hotelcity" id="locationid" required=""
                value="<?php echo @$hdata[0]->hotel_city; ?>">
            </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input type="text" name="tripadvisor" class="form-control" placeholder="TripAdvisor ID"
                value="<?php echo @$hdata[0]->tripadvisor_id;?>" />
            </div>
          </div>
          <?php } ?>
          <div class="row form-group">
            ...
            <div class="col-md-2">
              ...
              <select name="deposittype" class="form-control">
                ...
                <option value="percentage" <?php if(@$hoteldeposittype == "percentage"){ echo 'selected'; } ?>>
                  Percentage</option>
              </select>
              <?php }else{ ?><input type="text" class="form-control" name="deposittype"
                value="<?php echo $hoteldeposittype; ?>" readonly="readonly"><?php } ?>
            </div>
            <div class="col-md-2">
              <input type="text" class="form-control" id="" placeholder="Value" name="depositvalue"
                value="<?php echo @$hoteldepositval;?>" <?php if(!$isadmin){ echo "readonly"; } ?>>
            </div>
          </div>
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <select name="taxtype" class="form-control">
                ...
                <option value="percentage" <?php if(@$hoteltaxtype == "percentage"){ echo 'selected'; } ?>>Percentage
                </option>
              </select>
            </div>
            <div class="col-md-2">
              <input class="form-control" id="" Placeholder="Value" type="text" name="taxvalue"
                value="<?php echo @$hoteltaxval;?>" />
            </div>
          </div>
          <div class="row form-group">
            ...
            <div class="col-md-8">
              <select multiple class="chosen-multi-select" name="relatedhotels[]">
                ...
                <option value="<?php echo $hotel->hotel_id;?>"
                  <?php  if(in_array($hotel->hotel_id,@$hrelated)){ echo 'selected'; } ?>>
              ...
              <div class="col-md-6 form-horizontal">
                <table class="table">
                  <tr>
                    ...
                    <td>
                      <input type="text" class="form-control Places" id="mapaddress" name="hotelmapaddress"
                        value="<?php echo $hdata[0]->hotel_map_city;?>">
                    </td>
                  </tr>
                  <tr>
                    <td></td>
                  ...
                  <tr>
                    ...
                    <td><input type="text" class="form-control" id="latitude"
                        value="<?php echo $hdata[0]->hotel_latitude;?>" name="latitude" /></td>
                  </tr>
                  <tr>
                    <td>Longitude</td>
                    <td><input type="text" class="form-control" id="longitude"
                        value="<?php echo $hdata[0]->hotel_longitude;?>" name="longitude" /></td>
                  </tr>
                </table>
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-4">
                <label class="pointer"><input class="checkboxcls"
                    <?php if($submittype == "add"){ if( $hamt->sett_selected == "1"){echo "checked";} }else{ if(in_array($hamt->sett_id,$hamenity)){ echo "checked"; } } ?>
                    type="checkbox" name="hotelamenities[]" value="<?php echo $hamt->sett_id;?>">
                  <?php echo $hamt->sett_name;?></label>
              </div>
              <?php } ?>
            </div>
          </div>
        ...
        <div class="tab-pane wow fadeIn animated in" id="META_INFO">
          <div class="row form-group">
            ...
            <div class="col-md-6">
              <input name="hotelmetatitle" type="text" placeholder="Title" class="form-control"
                value="<?php echo @$hdata[0]->hotel_meta_title;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Meta Keywords</label>
            <div class="col-md-6">
              <textarea name="hotelkeywords" placeholder="Keywords" class="form-control" id="" cols="30"
                rows="2"><?php echo @$hdata[0]->hotel_meta_keywords;?></textarea>
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Meta Description</label>
            <div class="col-md-6">
              <textarea name="hotelmetadesc" placeholder="Description" class="form-control" id="" cols="30"
                rows="4"><?php echo @$hdata[0]->hotel_meta_desc;?></textarea>
            </div>
          </div>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="POLICY">
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <input name="checkintime" type="text" placeholder="Check In" class="form-control timepicker"
                data-format="hh:mm A" value="<?php echo $checkin;?>" />
            </div>
            <label class="col-md-2 control-label text-left">Check Out</label>
            <div class="col-md-2">
              <input name="checkouttime" type="text" placeholder="Check Out" class="form-control timepicker"
                data-format="hh:mm A" value="<?php echo $checkout;?>" />
            </div>
          </div>
          <div class="row form-group">
            ...
            <div class="col-md-6">
              <select multiple class="chosen-multi-select" name="hotelpayments[]">
                ...
                <option value="<?php echo $hpayment->sett_id;?>"
                  <?php if($submittype == "add"){ if( $hpayment->sett_selected == "1"){echo "selected";} }else{ if(in_array($hpayment->sett_id,$hotelpaytypes)){ echo "selected"; } } ?>>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-8">
              <textarea name="hotelpolicy" placeholder="Policy..." class="form-control" id="" cols="30"
                rows="7"><?php echo @$hdata[0]->hotel_policy;?></textarea>
            </div>
          </div>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="CONTACT">
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input name="hotelemail" type="text" placeholder="Email" class="form-control "
                value="<?php echo @$hdata[0]->hotel_email;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Hotel's Website</label>
            <div class="col-md-4">
              <input name="hotelwebsite" type="text" placeholder="Website" class="form-control "
                value="<?php echo @$hdata[0]->hotel_website;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Phone</label>
            <div class="col-md-4">
              <input name="hotelphone" type="text" placeholder="Phone" class="form-control"
                value="<?php echo @$hdata[0]->hotel_phone;?>" />
            </div>
          </div>
          <!--  <div class="row form-group">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="row form-group">
                <label class="col-md-2 control-label text-left">Hotel Name</label>
                <div class="col-md-4">
                  <input name='<?php echo "translated[$lang][title]"; ?>' type="text" placeholder="Hotel Name"
