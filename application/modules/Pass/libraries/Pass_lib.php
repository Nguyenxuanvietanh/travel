...
// Get Room Type to show instead of title
    ...
    public function suggestionResults_v2($query)
    {
        ...
        $this->db->select('pt_pass.pass_id as id, pt_pass_translation.trans_title, pt_pass.pass_title, (

            select location from pt_locations where id = pt_pass.pass_city) as city');
